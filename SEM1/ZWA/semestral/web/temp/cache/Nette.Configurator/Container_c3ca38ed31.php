<?php
// source: C:\Users\Vojcek\Documents\wamp64\www\semestral\app/config/config.neon 
// source: C:\Users\Vojcek\Documents\wamp64\www\semestral\app/config/config.local.neon 

class Container_c3ca38ed31 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\NoteManager' => [1 => ['24_App_Model_NoteManager']],
			'App\Model\NotebookManager' => [1 => ['25_App_Model_NotebookManager']],
			...
			'App\Presenters\NotebookPresenter' => [1 => ['application.4']],
			'App\Presenters\NotePresenter' => [1 => ['application.5']],
		...
		'services' => [
			'24_App_Model_NoteManager' => 'App\Model\NoteManager',
			'25_App_Model_NotebookManager' => 'App\Model\NotebookManager',
			...
			'application.4' => 'App\Presenters\NotebookPresenter',
			'application.5' => 'App\Presenters\NotePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Users\Vojcek\Documents\wamp64\www\semestral\app',
			'wwwDir' => 'C:\Users\Vojcek\Documents\wamp64\www\semestral\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\Users\Vojcek\Documents\wamp64\www\semestral\app/../temp',
		];
	}


	/**
	 * @return App\Model\NoteManager
	 */
	public function createService__24_App_Model_NoteManager()
	{
		$service = new App\Model\NoteManager($this->getService('database.default.connection'));
		return $service;
	}


	/**
	 * @return App\Model\NotebookManager
	 */
	public function createService__25_App_Model_NotebookManager()
	{
		$service = new App\Model\NotebookManager($this->getService('database.default.connection'),
			$this->getService('24_App_Model_NoteManager'));
		return $service;
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('25_App_Model_NotebookManager'),
			$this->getService('24_App_Model_NoteManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
	...
	/**
	 * @return App\Presenters\NotebookPresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\Presenters\NotebookPresenter($this->getService('25_App_Model_NotebookManager'),
			$this->getService('24_App_Model_NoteManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
	...
	{
		$service = new App\Presenters\NotePresenter($this->getService('25_App_Model_NotebookManager'),
			$this->getService('24_App_Model_NoteManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
	...
	{
		$service = new App\Presenters\SignPresenter($this->getService('26_App_Model_UserManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\Vojcek\Documents\wamp64\www\semestral\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\Vojcek\Documents\wamp64\www\semestral\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\Vojcek\Documents\wamp64\www\semestral\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=noteit', 'root',
			'root', ['lazy' => true, 1003 => true]);
	...
	{
		return new Container_c3ca38ed31_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_c3ca38ed31_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_c3ca38ed31 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\Users\Vojcek\Documents\wamp64\www\semestral\app/../temp/cache/latte');
