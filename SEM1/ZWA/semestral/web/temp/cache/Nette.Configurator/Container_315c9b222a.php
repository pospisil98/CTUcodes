...
class Container_315c9b222a extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		return new Container_315c9b222a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_315c9b222a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_315c9b222a $container)
	{
